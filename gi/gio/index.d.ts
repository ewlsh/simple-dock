...
export class BufferedInputStream extends FilterInputStream {
    constructor(config?: properties);
    buffer_size: number;
    static new_sized(base_stream: InputStream, size: number): InputStream;
...
export class BufferedOutputStream extends FilterOutputStream {
    ...
    auto_grow: boolean;
    buffer_size: number;
    static new_sized(base_stream: OutputStream, size: number): OutputStream;
...
export class DesktopAppInfo extends GObject.Object {
    constructor(config?: properties);
    filename: string;
    static new(appname: string): DesktopAppInfo | null; // TODO
...
export class InetSocketAddress extends SocketAddress {
    ...
    port: number;
    scope_id: number;
    static new_from_string(address: string, port: number): SocketAddress;
    static new_from_string(...args: never[]): never;
    get_address(): InetAddress;
    get_flowinfo(): number;
    get_port(): number;
...
export class MemoryOutputStream extends OutputStream {
    ...
    size: number;
    static new_resizable(): OutputStream;
...
export class SocketAddress extends GObject.Object {
    constructor(config?: properties);
    readonly family: SocketFamily;
    static new_from_native(_native: object, len: number): SocketAddress;
...
export class UnixCredentialsMessage extends SocketControlMessage {
    ...
    static new_with_credentials(credentials: Credentials): SocketControlMessage;
    get_credentials(): Credentials;
...
export class UnixFDMessage extends SocketControlMessage {
    constructor(config?: properties);
    fd_list: UnixFDList;
    static new_with_fd_list(fd_list: UnixFDList): SocketControlMessage;
...
export class UnixSocketAddress extends SocketAddress {
    ...
    static new_abstract(path: number[], path_len: number): SocketAddress;
