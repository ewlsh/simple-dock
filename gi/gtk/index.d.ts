...
export namespace IconSize {
    function lookup(size: IconSize): [number, number, number];
}
...
export class AppChooserDialog extends Dialog {
    ...
    gfile: Gio.File;
    heading: string;
    static new_for_content_type(parent: Window | null, flags: DialogFlags, content_type: string): Widget;
...
export class Bin extends Container { // TODO Bin extends Container
    constructor(config?: properties);
...
export class Builder extends GObject.Object {
    ...
    get_object(name: string): unknown | null;
    get_objects(): string[];
...
export class CellView extends Widget {
    ...
    fit_model: boolean;
    model: TreeModel;
    static new_with_context(area: CellArea, context: CellAreaContext): Widget;
...
export class ColorButton extends Button implements ColorChooser {
    constructor(config?: properties);
    alpha: number;
    color: Gdk.Color;
    rgba: Gdk.RGBA;
    ...
    title: string;
    use_alpha: boolean;
    static new_with_color(color: Gdk.Color): Widget;
...
export class ComboBox extends Bin {
    ...
    wrap_width: number;
    static new_with_area(area: CellArea): Widget;
...
export class ComboBoxText extends ComboBox {
    ...
    remove(position: never): void; // TODO
    remove(position: number): void;
    remove_all(): void;
}
export class Container extends Widget { // TODO Issue: Container doesn't extend Widget
    constructor(config?: properties);
    border_width: number;
    child: Widget;
...
export class Entry extends Widget {
    ...
    width_chars: number;
    xalign: number;
    static new_with_buffer(buffer: EntryBuffer): Widget;
...
export class Expander extends Bin {
    ...
    use_markup: boolean;
    use_underline: boolean;
    static new_with_mnemonic(label: string | null): Widget;
...
export class FileChooserButton extends Box {
    ...
    title: string;
    width_chars: number;
    static new_with_dialog(dialog: Dialog): Widget;
...
export class FontButton extends Button {
    ...
    use_font: boolean;
    use_size: boolean;
    static new_with_font(fontname: string): Widget;
...
export class ImageMenuItem extends MenuItem {
    ...
    image: Widget;
    use_stock: boolean;
    static new_from_stock(stock_id: string, accel_group: AccelGroup | null): Widget;
    static new_from_stock(...args: never[]): never;
    static new_with_label(label: string): Widget;
    static new_with_label(...args: never[]): never;
    static new_with_mnemonic(label: string): Widget;
...
export class Invisible extends Widget {
    constructor(config?: properties);
    screen: Gdk.Screen;
    static new_for_screen(screen: Gdk.Screen): Widget;
...
export class Label extends Misc {
    ...
    xalign: number;
    yalign: number;
    static new_with_mnemonic(str: string | null): Widget;
    static new_with_mnemonic(...args: never[]): never;
    get_angle(): number;
    get_attributes(): Pango.AttrList | null;
...
export class LevelBar extends Widget {
    ...
    mode: LevelBarMode;
    value: number;
    static new_for_interval(min_value: number, max_value: number): Widget;
...
export class LinkButton extends Button {
    ...
    uri: string;
    visited: boolean;
    static new_with_label(uri: string, label: string | null): Widget;
    static new_with_label(...args: never[]): never;
    get_uri(): string;
    get_visited(): boolean;
...
export class Menu extends MenuShell {
    ...
    tearoff_title: string;
    static new_from_model(model: Gio.MenuModel): Widget;
...
export class MenuButton extends ToggleButton {
    ...
    set_direction(direction: never): void;
...
export class MenuToolButton extends ToolButton {
    constructor(config?: properties);
    menu: Menu;
    static new_from_stock(stock_id: string): ToolItem;
    get_menu(): Widget;
...
export class Plug extends Window {
    ...
    static new_for_display(display: Gdk.Display, socket_id: xlib.Window): Widget;
...
export class Popover extends Bin {
    ...
    static new_from_model(relative_to: Widget | null, model: Gio.MenuModel): Widget;
...
export class RadioButton extends CheckButton {
    constructor(config?: properties);
    group: RadioButton;
    static new_from_widget(radio_group_member: RadioButton | null): Widget;
...
export class RadioMenuItem extends CheckMenuItem {
    constructor(config?: properties);
    group: RadioMenuItem;
    static new_from_widget(group: RadioMenuItem | null): Widget;
    static new_from_widget(...args: never[]): never;
    static new_with_label(group: string[], label: string): Widget;
    static new_with_label(...args: never[]): never;
...
export class RadioToolButton extends ToggleToolButton {
    ...
    static new_from_stock(group: string[], stock_id: string): ToolItem;
    static new_from_stock(...args: never[]): never;
...
export class RecentAction extends Action {
    ...
    static new_for_manager(name: string, label: string | null, tooltip: string | null, stock_id: string | null, manager: RecentManager | null): Action;
...
export class Scale extends Range {
    ...
    static new_with_range(orientation: Orientation, min: number, max: number, step: number): Widget;
    static new_with_range(...args: never[]): never;
...
export class TextView extends Container {
    ...
    top_margin: number;
    wrap_mode: WrapMode;
    static new_with_buffer(buffer: TextBuffer): Widget;
    static new_with_buffer(...args: never[]): never;
...
export class Window extends Bin {
    ...
    maximize(): void;
    mnemonic_activate(...args: never[]): boolean;
...
declare function Implements<T extends Constructor<{}>, K extends Constructor<{}>>(Base: T, Implements: K): Constructor<T & K>
